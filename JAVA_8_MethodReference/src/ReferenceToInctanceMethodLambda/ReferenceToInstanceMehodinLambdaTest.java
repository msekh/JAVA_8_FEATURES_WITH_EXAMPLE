package ReferenceToInctanceMethodLambda;

import java.util.ArrayList;
import java.util.List;
import java.util.function.Function;

public class ReferenceToInstanceMehodinLambdaTest {
public static void main(String args[]) {
	...
	List<String> personNames=ReferenceToInstanceMehodinLambdaTest.getPersonsName(persons,Person::getName);
